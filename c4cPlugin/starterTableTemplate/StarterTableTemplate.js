define(
	function() {
		return {
			...
			configWizardSteps: function(oSelectBOStep, tableCustomization) {

			/*	var oCatalogStepContent = oCatalogstep.getStepContent();
				var oTableSettingsStepContent = oTableSettingsStep.getStepContent();
				var oTableSettingsStepContent = oTableSettingsStep.getStepContent();
				var oTableSettingsStepContent = oTableSettingsStep.getStepContent();

				/*oCatalogStepContent.attachValidation(oTemplateCustomizationStepContent.onSelectedServiceChange,
	            ...
	            var tableCustomizationStepContent = tableCustomization.getStepContent();
		        oSelectBOStepContent.attachValueChange(tableCustomizationStepContent.onChangeDestination,tableCustomizationStepContent);
		        oSelectBOStepContent.attachValueChange(tableCustomizationStepContent.onChangeBO,tableCustomizationStepContent);
				return [oSelectBOStep, tableCustomization];
			}
		};
	}
