define({
	...
	getContent: function() {
		...
		return Q.sap.require("sap.hcp.c4c.plugin/control/CreateStepContent" , true).then(function(){
		   
	   		var oStepContent = new sap.hcp.c4c.plugin.control.CreateStepContent({
				context: that.context
			});

			var sStepTitle = that.context.i18n.getText("c4c_create_step_name");
			var sStepDescription ="";//that.context.i18n.getText("c4c_create_step_desc");
