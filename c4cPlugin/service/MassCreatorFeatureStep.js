define({
	...
	getContent: function() {
		...
		return Q.sap.require("sap.hcp.c4c.plugin/control/MassCreatorFeatureStepContent" , true).then(function(){
		   

	   		var oStepContent = new sap.hcp.c4c.plugin.control.MassCreatorFeatureStepContent({
