define({
	...
	getContent: function() {
		...
		return Q.sap.require("sap.hcp.c4c.plugin/control/MassContentCreatorFeatureStepContent" , true).then(function(){
		   

	   		var oStepContent = new sap.hcp.c4c.plugin.control.MassContentCreatorFeatureStepContent({
				context: that.context
			});
          
			var sStepTitle = that.context.i18n.getText("c4c_solution_component_select_step_name");
			var sStepDescription =that.context.i18n.getText("c4c_solution_component_select_step_desc");
