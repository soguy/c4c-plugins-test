jQuery.sap.declare("sap.hcp.c4c.plugin.control.TableCustomizationFeatureStepContent");
...
sap.watt.ideplatform.plugin.template.ui.wizard.WizardStepContent.extend(
	"sap.hcp.c4c.plugin.control.TableCustomizationFeatureStepContent", {
		...
		_createContent: function() {
		   var src = require.toUrl("sap.hcp.c4c.plugin/starterTableTemplate/image/preview.png"); 
		   var oImage = new sap.ui.commons.Image({src : src}); 
		   var oLayout = new sap.ui.layout.VerticalLayout({
          	    content: [oImage]
          }).addStyleClass("table-cust-layout");
		...
		setViewModel: function(){
            ...
            var currentBO = utils.createModelForTableTemplate(this.bo, this.parser);
